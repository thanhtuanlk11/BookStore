			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					...
					<strong>Langbiang
					  ...
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: 15 Thông Thiên Học<br>
					
					  <span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Điện thoại: 0123699669<br>
			
					</address>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right">
					<a href="https://www.facebook.com/sachcuhoagiay"><img src="<?php echo base_url(); ?>upload/icon/facebook-48.png" alt=""></a>
					<a href="https://www.tiktok.com/@hyu_phan"><img src="<?php echo base_url(); ?>upload/icon/tiktok-48.png" alt=""></a>
					<a href="https://www.youtube.com/channel/UCRV3U7WR3eCYHC7GLZL5Zog"><img src="<?php echo base_url(); ?>upload/icon/youtube-48.png" alt=""></a>
				</div>
